...
export const ModerationTools = () => {
  ...
  const handleSaveMessage = () => {
    async function fetchGroup() {
      try {
        // GET group info
        const res = await fetch(`/api/telegramgroup/${-1002679451985}`, {
          method: "PUT",
          ...
          body: JSON.stringify({
            ...
            wordFilters: settings.wordFilters,
          }),
        });
        ...
        setSettings({
          ...
          welcomeEnabled: group.isWelcome || false,
          goodbyeEnabled: group.isGoodbye || false,
          spamProtection: group.spam || false,
          wordFilters: group.bannedWords || [],
        });
        alert("Saved");
      } catch (err) {
  ...
  useEffect(() => {
    async function fetchGroup() {
      try {
        ...
        // {_id: '688b9d367ac88f4e5ec2b059', groupId: -1002679451985, __v: 6, bannedWords: Array(4), goodbyeMessage: '/listfilters@latestrosebot', …}bannedWords: (4) ['spamword_or_link', 'spamword_or_l', 'spamword_', 'filter']goodbyeMessage: "/listfilters@latestrosebot"goodbyePhotoId: nullgroupId: -1002679451985isGoodbye: trueisWelcome: truejoinedAt: "2025-08-13T16:59:20.044Z"spam: trueuserId: 5821395927welcomeMessage: "Welcomeeee"welcomePhotoId: null__v: 6_id: "688b9d367ac88f4e5ec2b059"[[Prototype]]: Object
      } catch (err) {
        console.error("Error:", err);
      }
    }
    ...
    <Card className="bg-[#171717] shadow-md">
      ...
      <CardContent className="space-y-[24px]">
        ...
        <div className="space-y-[12px]">
          ...
          <div className="space-y-[8px]">
            <Textarea
              ...
              className="min-h-[80px] bg-black border-none text-white"
            />
            <div className="flex items-center gap-[8px]">
              <Label
                htmlFor="welcome-message"
        ...
        <Button
          ...
          className="bg-[black] text-white hover:bg-success/90 w-full mt-[16px] flex items-center justify-center"
        >
